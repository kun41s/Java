...
In other words, it will check whether the ID has been registered previously by another user.
You are assigned the task of checking whether a particular email ID that comes in for registration already exists or not.
You are given an array of the following emails that are already registered with the website:
[“chandler.bing@xyz.com”, “ross.geller@xyz.com”, “rachel.greene@xyz.com”, “joey.tribbiani@xyz.com”, “monica.geller@xyz.com”, “phoebe.buffay@xyz.com”, “sheldon.copper@xyz.com”, “marie.george@xyz.com”].
A new entry called monica.geller@xyz.com is received. Write a code that checks whether this ID is already registered or not.
...
package DataStructureAndAlgorithm.Hashtable;
import java.util.*;

public class CheckRegisterEmails {
